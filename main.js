...
for (var i=0;i<=5;i++) {
    ...
    grav[i] = new GRAVITYCLUSTER(Math.random()*window.innerWidth, Math.random()*window.innerHeight, Math.random() * 30 + 1, 0);
}
...
function GRAVITYCLUSTER(centerX, centerY, amount, idizzle) {
    ...
    for (var i = 0; i < amount; i++) {
        this.plat[i] = new Platforms(this.cX, this.cY, idizzle);
    }
...
function Platforms(cx, cy, gravId) {
